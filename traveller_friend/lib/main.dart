...
import 'package:traveller_friend/travell_ui/signin.dart';
import 'package:traveller_friend/travell_ui/signup.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'Travell Friend',
      theme: ThemeData(fontFamily: 'Lato', primaryColor: Colors.redAccent, primaryColorDark: Colors.red),
