import 'package:coronaupdate/utils/constants.dart';
import 'package:coronaupdate/widgets/social_button.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:url_launcher/url_launcher.dart';

_launchURL() async {
  const url = 'mailto:arifurrahaman94@gmail.com';
...
_launchLinkedURL() async {
  const url = 'https://www.linkedin.com/in/arifurrahaman-cse-bubt/';
  if (await canLaunch(url)) {
    await launch(url);
  } else {
    throw 'Could not launch $url';
...
_launchFacebookURL() async {
  const url = 'https://www.facebook.com/arifurrahaman.cse.bubt';
  if (await canLaunch(url)) {
    await launch(url);
  } else {
    throw 'Could not launch $url';
