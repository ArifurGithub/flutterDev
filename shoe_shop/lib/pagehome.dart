      ...
      appBar: AppBar(
        ...
        title: Row(
          children: <Widget>[
            ...
            Text('Product Details', style: TextStyle(color: Colors.red),textAlign: TextAlign.center,)
          ],
        ),
        actions: <Widget>[
                ...
                Row(
                  ...
                  children: <Widget>[
                    Container(
                      width: 250,
                      child: Text(
                        'Kedo Runing Shoes from Arif Shop',
                        style: TextStyle(
                    ...
                    children: <Widget>[
                      Row(
                          children: <Widget>[
                            ...
                            Text(
                              'Cash on delivery available on all bellow BDT.5000',
